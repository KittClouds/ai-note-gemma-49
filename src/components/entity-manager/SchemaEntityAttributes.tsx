...
export function SchemaEntityAttributes({ 
  ...
  const getTypeColor = (type: AttributeType): string => {
    const colors: Record<AttributeType, string> = {
      ...
      RichText: 'bg-amber-500/20 text-amber-400',
      ImageURL: 'bg-teal-500/20 text-teal-400',
      ColorPicker: 'bg-violet-500/20 text-violet-400',
      Rating: 'bg-red-500/20 text-red-400',
      Tags: 'bg-lime-500/20 text-lime-400',
      FileReference: 'bg-gray-500/20 text-gray-400'
    };
